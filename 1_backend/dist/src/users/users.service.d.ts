...
export declare class UsersService {
    ...
    constructor(userModel: Model<User>, credentialsModel: Model<UserCredentials>, postModel: Model<Post>, commentModel: Model<Comment>, conversationModel: Model<Conversation>, messageModel: Model<Message>, notificationModel: Model<Notification>);
    findById(userId: string, currentUserId?: string): Promise<{
        id: string;
        _id: string;
        isFollowing: boolean;
